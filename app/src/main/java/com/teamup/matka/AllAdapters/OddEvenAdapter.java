...
public class OddEvenAdapter extends RecyclerView.Adapter<OddEvenAdapter.ViewHolder> {
    ...
    public OddEvenAdapter(List<String> blog_list) {
        this.blog_list = blog_list;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_odd_even, parent, false);
...
//        final String PostId = blog_list.get(position).FacebookPostId;
        ...
        holder.no_txt.setText("" + blog_list.get(position));
        ...
        holder.no_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Flubber.with()
                        .animation(Flubber.AnimationPreset.ALPHA) // Slide up animation
                        .repeatCount(2)                              // Repeat once
                        .duration(500)                              // Last for 1000 milliseconds(1 second)
                        .createFor(holder.no_txt)                             // Apply it to the view
                        .start();
//                Admin.position = position;
//                AppSyncYesNoDialog.showDialog(context, "Are you sure you want to delete "+ blog_list.get(position) + "?");
            }
        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView no_txt, Txt2, Txt3, Txt4, Txt5;
        private View mView;
