...
public class WinningAdapter extends RecyclerView.Adapter<WinningAdapter.ViewHolder> {
    ...
    public WinningAdapter(List<String> blog_list) {
        this.blog_list = blog_list;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_winning_ratio, parent, false);
...
//        final String PostId = blog_list.get(position).FacebookPostId;
        ...
        holder.title_txt.setText("" + blog_list.get(position));
