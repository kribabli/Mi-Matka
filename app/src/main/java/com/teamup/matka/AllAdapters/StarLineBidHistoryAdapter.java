...
import com.teamup.matka.AllActivities.StalineBidDetailsHistory;
...
public class StarLineBidHistoryAdapter extends RecyclerView.Adapter<StarLineBidHistoryAdapter.ViewHolder> {
    ...
    public StarLineBidHistoryAdapter(List<StarGamesReq> blog_list) {
        this.blog_list = blog_list;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_starline_bid_history, parent, false);
...
//        final String PostId = blog_list.get(position).FacebookPostId;
        ...
        holder.title_txt.setText("" + blog_list.get(position).getStime());

        holder.liner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Admin.marketId = blog_list.get(position).getId();
                context.startActivity(new Intent(context, StalineBidDetailsHistory.class));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView title_txt, Txt2, Txt3, Txt4, Txt5;
        private View mView;
